a = int(input('a = ', ))    # запрашиваем число а
b = int(input('b = ', ))    # запрашиваем число b
c = int(input('c = ', ))    # запрашиваем число c
...
if a != 0 and c != 0 and b == 0:        # решение уравнения при b = 0
    if (- c / a) > 0:         #Удаляем из этого условия знак '=', оставляем только знак '>'
        k1 = (-c / a) ** 0.5
...
if a != 0 and c== 1 and b != 0:     # решение уравнения при с = 1
